...
import { getExperiments, getExperimentById } from '@/services/experiment.service';
import { TrendChart } from '@/charts/TrendChart';
import { Bot, BarChart3, TrendingUp, Layers } from 'lucide-react';

export function Dashboard() {
  const { response, evaluation, layerStates, setLayersFromExperiment } = useAppStore();
  const [recentExperiments, setRecentExperiments] = React.useState<any[]>([]);
