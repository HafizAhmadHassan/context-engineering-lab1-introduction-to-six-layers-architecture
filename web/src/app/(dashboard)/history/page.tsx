...
import { Star, Trash2, Eye, Clock, DollarSign, FileText, TrendingUp, ExternalLink } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard" className="text-sm text-muted-foreground hover:text-primary flex items-center gap-1">
          <ExternalLink className="h-4 w-4" /> New Experiment
        </Link>
      </div>

      <div className="p-3 rounded-lg bg-secondary/50 text-xs text-muted-foreground">
        Experiments are stored locally in your browser (GitHub Pages has no backend). Clear your browser data to reset.
      </div>
