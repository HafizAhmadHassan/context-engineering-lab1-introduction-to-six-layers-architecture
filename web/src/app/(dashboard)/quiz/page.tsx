...
const questions: Question[] = [
  {
    ...
    options: ['System prompt', 'The context window', 'Training data', 'Model weights'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['System prompt', 'Model parameters', 'RAG databases and vector stores', 'Tokenizer vocabulary'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['System prompt', 'The user prompt', 'Model architecture', 'Training data'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['System prompts', 'Conversation history', 'RAG', 'Model temperature'],
    correctIndex: 3,
  ...
  },
  {
    ...
    options: ['Model drift', 'Data leakage', 'Context Rot', 'Token fragmentation'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['7,000 words — 30 pages', '70,000 words — 300 pages', '700,000 words — ~3,000 pages', '7,000,000 words — 30,000 pages'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Improved accuracy across all tasks', 'Increased noise, degraded response quality, higher latency', 'Reduced computational cost', 'The model automatically summarizes the excess'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Stale information', 'Mixed tokenization schemes', 'Contradictory instructions', 'Irrelevant context reducing the signal-to-noise ratio'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Prompt Engineering uses more tokens overall', 'Context Engineering includes dynamic components such as RAG, memory, and tool outputs', 'Context Engineering only works with large models', 'Prompt Engineering is fully automated'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['The model forgets how to be empathetic', 'The system prompt gets diluted as more conversation accumulates in context', 'Empathy requires a larger model than the one deployed', 'The token limit causes the model to respond faster'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Documents placed at the very beginning of the prompt', 'Documents placed at the very end of the prompt', 'Documents placed near the middle of the prompt', 'Short documents regardless of position'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Generate responses entirely from the model\'s parameters', 'Select relevant information from a larger corpus to include in the prompt', 'Fine-tune the model on new training data', 'Re-rank all model outputs before returning them'],
    correctIndex: 1,
